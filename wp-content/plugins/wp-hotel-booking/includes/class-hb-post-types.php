...
class HB_Post_Types {
    ...
    function register_post_types() {
        ...
        $args = array(
            'labels' => array(
                'name' => _x( 'Номера', 'post type general name', 'tp-hotel-booking' ),
                'singular_name' => _x( 'Room', 'post type singular name', 'tp-hotel-booking' ),
				'description'        => __( 'Description.', 'tp-hotel-booking' ),
                'menu_name' => __( 'Номера', 'tp-hotel-booking' ),
                'parent_item_colon' => __( 'Parent Item:', 'tp-hotel-booking' ),
                'all_items' => __( 'Номера', 'tp-hotel-booking' ),
