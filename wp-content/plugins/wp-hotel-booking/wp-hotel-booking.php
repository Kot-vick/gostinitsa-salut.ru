...
class TP_Hotel_Booking {
	...
	public function includes() {
		...
		if ( apply_filters( 'hotel_booking_enable_currency_addon', true ) ) {
			$this->_include( 'includes/plugins/wp-hb-currencies/tp-hb-currencies.php' );
		}
		$this->_include( 'includes/plugins/wp-hb-extra/tp-hb-extra.php' );
		// // end addon
