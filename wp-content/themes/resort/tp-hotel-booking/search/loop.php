                ...
                <ul class="hb-room-meta">
                    ...
                    <li class="hb_search_price">
                        ...
                        <div class="hb_view_price">
                            <a href="" class="hb-view-booking-room-details"><?php _e( '(View price breakdown)', 'resort' ); ?></a>
                        ...
                        <div>
							...
							hb_dropdown_numbers(
								array(
									...
									'min'              => 1,
									'show_option_none' => __( 'Select', 'resort' ),
                    ...
                    <li class="hb_search_add_to_cart">
                        <button class="hb_add_to_cart"><?php _e( 'Select This Room', 'resort' ) ?></button>
                    </li>
                </ul>
            </div>
        </div>
