    ...
    <div id="comment-<?php comment_ID(); ?>" class="comment_container">
        ...
        <div class="comment-text">
			...
			<?php if ( $rating && $settings->get( 'enable_review_rating' ) ) : ?>
                ...
                <div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf( __( 'Rated %d out of 5', 'resort' ), $rating ) ?>">
			...
			<?php if ( $comment->comment_approved == '0' ) : ?>
                ...
                <p class="meta"><em><?php _e( 'Your comment is awaiting approval', 'resort' ); ?></em></p>
