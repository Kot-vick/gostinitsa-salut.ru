...
if ( !$bookings ) {
	_e( 'You have no order booking system', 'resort' );
	return;
}
...
<div class="hb_booking_wrapper">
    ...
    <h2><?php _e( 'Bookings', 'resort' ) ?></h2>

    <table class="hb_booking_table">

        <thead>
        <tr>
            <th><?php _e( 'ID', 'resort' ); ?></th>
            <th><?php _e( 'Booking Date', 'resort' ); ?></th>
            <th><?php _e( 'Total', 'resort' ); ?></th>
            <th><?php _e( 'Status', 'resort' ); ?></th>
        </tr>
        </thead>
