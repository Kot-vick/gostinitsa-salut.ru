...
<?php if ( $rooms ): ?>
    ...
    <div class="hb_mini_cart_footer">
        ...
        <a href="<?php echo esc_url( hb_get_checkout_url() ); ?>" class="hb_button hb_checkout"><?php _e( 'Check Out', 'resort' ); ?></a>
        <a href="<?php echo esc_url( hb_get_cart_url() ); ?>" class="hb_button hb_view_cart"><?php _e( 'View Cart', 'resort' ); ?></a>
