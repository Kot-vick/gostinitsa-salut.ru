...
if( $resort_config['layout'] != 'layout_1' && $resort_config['layout'] != 'layout_12' ) {
	$marker_id = $resort_config['layout'] . '_';
}
...
<?php if ( ! empty( $content ) ): ?>
	<div id="<?php echo esc_attr( $map_id ); ?>" class="tmc_gmap_wrapper<?php echo esc_attr( $css_class ); ?>">
		...
		<?php } ?>
		<div<?php echo( ( $map_style ) ? ' style="' . esc_attr( implode( ' ', $map_style ) ) . '"' : '' ); ?> id="<?php echo esc_attr( $gmap_id ); ?>" class="tmc_gmap"></div>
			...
			jQuery(document).ready(function ($) {
				...
				function init() {
					...
					<?php if( !empty( $gmap_style ) ) : ?>
						mapStyles = <?php echo rawurldecode(strip_tags($gmap_style)); ?>;
					<?php endif; ?>
